...
4. **Zero Runtime Dependencies**: Headless primitives should have minimal to zero external runtime dependencies. Svelte 5 built-in runes and DOM APIs are preferred.
